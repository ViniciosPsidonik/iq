    ...
    if (ws.readyState === WebSocket.OPEN) {
        ...
        if (message.name == 'candles') {
            ...
            if (candles) {
                ...
                if (require('technicalindicators').eveningdojistar(velas3)) {
                    console.log('eveningdojistar');
                    buyBefor('put', parseInt(message.request_id), 1)
                } else if (require('technicalindicators').eveningstar(velas3)) {
                    console.log('eveningstar');
                    buyBefor('put', parseInt(message.request_id), 1)
                } else if (require('technicalindicators').morningdojistar(velas3)) {
                    console.log('morningdojistar');
                    buyBefor('call', parseInt(message.request_id), 1)
                } else if (require('technicalindicators').morningstar(velas3)) {
