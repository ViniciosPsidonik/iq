...
function buyBefor(direction, parInt) {
    ...
    let hourmm = moment.unix(currentTime / 1000).utcOffset(-3).add(timeFrame, 'm').format(" HH:mm");
    ...
    // } else {
    //     console.log(`Erro ao comprar por falta de tempo = timeIntLast - ${timeIntLast} / ${currentTimemmssDate}`);
    // }
